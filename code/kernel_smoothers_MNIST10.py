...
from kernel_smoothers import fu_KS
		...
		for i in range(10):
		    ...
		    for k in range(len(learning_labels)):
		        if learning_labels[k] == i:
		            ...
		            tmp_labels[k] = 0
		    collection_of_f[:, i] = fu_KS(reduced_images, tmp_labels, h = sigma**2)
